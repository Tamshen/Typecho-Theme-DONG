<div class="mdui-drawer mdui-drawer-close mdui-shadow-2 sidebar" id="drawer" overlay="true">
  ...
  <li class="mdui-collapse-item">
    ...
    <ul class="mdui-collapse-item-body mdui-list mdui-list-dense">
        ...
        <?php Links_Plugin::output('
        	...
        	<a href="{url}" title="{title}" target="_blank"><li class="mdui-list-item mdui-ripple">

      <i class="mdui-list-item-icon mdui-icon material-icons"><img class="mdui-img-circle" src="{image}" alt="{name}" width="20px" height="20px" />
